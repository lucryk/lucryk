...
- ⚡ В свободное время решаю задачи на Codewars, читаю статьи на habr и занимаюсь спортом, "В здоровом теле - здоровый дух".
</p>
...
[![codewars](https://www.codewars.com/users/kyznec0ff/badges/large)]((https://www.codewars.com/users/kyznec0ff))
